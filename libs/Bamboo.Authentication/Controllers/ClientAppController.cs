...
public class ClientAppController : AbpController
{
    ...
    [HttpPost]
    public async Task<ActionResult<ClientAppDto>> CreateAsync(ClientAppDto input)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<ClientAppDto>> UpdateAsync(Guid id, ClientAppDto input)
    {

...
public partial class AccountReconcileModel
{
    ...
    [InverseProperty("AccountReconcileModel")]
    public virtual ICollection<AccountReconcileModelResPartnerCategoryRel> AccountReconcileModelResPartnerCategoryRels { get; } = new List<AccountReconcileModelResPartnerCategoryRel>();

...
public static class CoreDbModelCreatingExtensions
{
    public static void ConfigureCoreExt(this ModelBuilder modelBuilder)
    {
        modelBuilder
        ...
        modelBuilder.Entity<AccountAccountAccountTag>(entity =>
        {
            entity.HasKey(e => new { e.AccountAccountId, e.AccountAccountTagId }).HasName("account_account_account_tag_pkey");

            entity.HasOne(d => d.AccountAccount).WithMany(p => p.AccountAccountAccountTags).HasConstraintName("account_account_account_tag_account_account_id_fkey");
        });

        modelBuilder.Entity<AccountAccountFinancialReportType>(entity =>
        {
            entity.HasKey(e => new { e.ReportId, e.AccountTypeId }).HasName("account_account_financial_report_type_pkey");

            entity.HasOne(d => d.Report).WithMany(p => p.AccountAccountFinancialReportTypes).HasConstraintName("account_account_financial_report_type_report_id_fkey");
        });
        ...
        modelBuilder.Entity<AccountAccountTagAccountMoveLineRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountMoveLineId, e.AccountAccountTagId }).HasName("account_account_tag_account_move_line_rel_pkey");

            entity.HasOne(d => d.AccountMoveLine).WithMany(p => p.AccountAccountTagAccountMoveLineRels).HasConstraintName("account_account_tag_account_move_line_account_move_line_id_fkey");
        });

        modelBuilder.Entity<AccountAccountTagAccountTaxRepartitionLineRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountTaxRepartitionLineId, e.AccountAccountTagId }).HasName("account_account_tag_account_tax_repartition_line_rel_pkey");

            entity.HasOne(d => d.AccountTaxRepartitionLine).WithMany(p => p.AccountAccountTagAccountTaxRepartitionLineRels).HasConstraintName("account_account_tag_account_t_account_tax_repartition_line_fkey");
        });

        modelBuilder.Entity<AccountAccountTagProductTemplateRel>(entity =>
        {
            entity.HasKey(e => new { e.ProductTemplateId, e.AccountAccountTagId }).HasName("account_account_tag_product_template_rel_pkey");

            entity.HasOne(d => d.ProductTemplate).WithMany(p => p.AccountAccountTagProductTemplateRels).HasConstraintName("account_account_tag_product_template_r_product_template_id_fkey");
        });
        ...
        modelBuilder.Entity<AccountAccountTemplateAccountTag>(entity =>
        {
            entity.HasKey(e => new { e.AccountAccountTemplateId, e.AccountAccountTagId }).HasName("account_account_template_account_tag_pkey");

            entity.HasOne(d => d.AccountAccountTemplate).WithMany(p => p.AccountAccountTemplateAccountTags).HasConstraintName("account_account_template_accou_account_account_template_id_fkey");
        });
        ...
        modelBuilder.Entity<AccountEdiFormatAccountJournalRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountJournalId, e.AccountEdiFormatId }).HasName("account_edi_format_account_journal_rel_pkey");

            entity.HasOne(d => d.AccountJournal).WithMany(p => p.AccountEdiFormatAccountJournalRels).HasConstraintName("account_edi_format_account_journal_rel_account_journal_id_fkey");
        });
        ...
        modelBuilder.Entity<AccountFiscalPositionResCountryStateRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountFiscalPositionId, e.ResCountryStateId }).HasName("account_fiscal_position_res_country_state_rel_pkey");

            entity.HasOne(d => d.AccountFiscalPosition).WithMany(p => p.AccountFiscalPositionResCountryStateRels).HasConstraintName("account_fiscal_position_res_cou_account_fiscal_position_id_fkey");
        });
        ...
        modelBuilder.Entity<AccountFiscalPositionTemplateResCountryStateRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountFiscalPositionTemplateId, e.ResCountryStateId }).HasName("account_fiscal_position_template_res_country_state_rel_pkey");

            entity.HasOne(d => d.AccountFiscalPositionTemplate).WithMany(p => p.AccountFiscalPositionTemplateResCountryStateRels).HasConstraintName("account_fiscal_position_templ_account_fiscal_position_temp_fkey");
        });
        ...
        modelBuilder.Entity<AccountReconcileModelResPartnerCategoryRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountReconcileModelId, e.ResPartnerCategoryId }).HasName("account_reconcile_model_res_partner_category_rel_pkey");

            entity.HasOne(d => d.AccountReconcileModel).WithMany(p => p.AccountReconcileModelResPartnerCategoryRels).HasConstraintName("account_reconcile_model_res_pa_account_reconcile_model_id_fkey1");
        });
        ...
        modelBuilder.Entity<AccountReconcileModelTemplateResPartnerCategoryRel>(entity =>
        {
            entity.HasKey(e => new { e.AccountReconcileModelTemplateId, e.ResPartnerCategoryId }).HasName("account_reconcile_model_template_res_partner_category_rel_pkey");

            entity.HasOne(d => d.AccountReconcileModelTemplate).WithMany(p => p.AccountReconcileModelTemplateResPartnerCategoryRels).HasConstraintName("account_reconcile_model_temp_account_reconcile_model_temp_fkey1");
        });
        ...
        modelBuilder.Entity<AccountTaxRepartitionFinancialTag>(entity =>
        {
            entity.HasKey(e => new { e.AccountTaxRepartitionLineTemplateId, e.AccountAccountTagId }).HasName("account_tax_repartition_financial_tags_pkey");

            entity.HasOne(d => d.AccountTaxRepartitionLineTemplate).WithMany(p => p.AccountTaxRepartitionFinancialTags).HasConstraintName("account_tax_repartition_finan_account_tax_repartition_line_fkey");
        });
        ...
        modelBuilder.Entity<CrmIapLeadIndustryCrmIapLeadMiningRequestRel>(entity =>
        {
            entity.HasKey(e => new { e.CrmIapLeadMiningRequestId, e.CrmIapLeadIndustryId }).HasName("crm_iap_lead_industry_crm_iap_lead_mining_request_rel_pkey");

            entity.HasOne(d => d.CrmIapLeadMiningRequest).WithMany(p => p.CrmIapLeadIndustryCrmIapLeadMiningRequestRels).HasConstraintName("crm_iap_lead_industry_crm_iap_crm_iap_lead_mining_request__fkey");
        });
        ...
        modelBuilder.Entity<CrmIapLeadMiningRequestCrmIapLeadRoleRel>(entity =>
        {
            entity.HasKey(e => new { e.CrmIapLeadMiningRequestId, e.CrmIapLeadRoleId }).HasName("crm_iap_lead_mining_request_crm_iap_lead_role_rel_pkey");

            entity.HasOne(d => d.CrmIapLeadMiningRequest).WithMany(p => p.CrmIapLeadMiningRequestCrmIapLeadRoleRels).HasConstraintName("crm_iap_lead_mining_request__crm_iap_lead_mining_request__fkey2");
        });

        modelBuilder.Entity<CrmIapLeadMiningRequestCrmTagRel>(entity =>
        {
            entity.HasKey(e => new { e.CrmIapLeadMiningRequestId, e.CrmTagId }).HasName("crm_iap_lead_mining_request_crm_tag_rel_pkey");

            entity.HasOne(d => d.CrmIapLeadMiningRequest).WithMany(p => p.CrmIapLeadMiningRequestCrmTagRels).HasConstraintName("crm_iap_lead_mining_request_c_crm_iap_lead_mining_request__fkey");
        });

        modelBuilder.Entity<CrmIapLeadMiningRequestResCountryRel>(entity =>
        {
            entity.HasKey(e => new { e.CrmIapLeadMiningRequestId, e.ResCountryId }).HasName("crm_iap_lead_mining_request_res_country_rel_pkey");

            entity.HasOne(d => d.CrmIapLeadMiningRequest).WithMany(p => p.CrmIapLeadMiningRequestResCountryRels).HasConstraintName("crm_iap_lead_mining_request_r_crm_iap_lead_mining_request__fkey");
        });

        modelBuilder.Entity<CrmIapLeadMiningRequestResCountryStateRel>(entity =>
        {
            entity.HasKey(e => new { e.CrmIapLeadMiningRequestId, e.ResCountryStateId }).HasName("crm_iap_lead_mining_request_res_country_state_rel_pkey");

            entity.HasOne(d => d.CrmIapLeadMiningRequest).WithMany(p => p.CrmIapLeadMiningRequestResCountryStateRels).HasConstraintName("crm_iap_lead_mining_request__crm_iap_lead_mining_request__fkey1");
        });
        ...
        modelBuilder.Entity<CrmTagRel>(entity =>
        {
            entity.HasKey(e => new { e.LeadId, e.TagId }).HasName("crm_tag_rel_pkey");

            entity.HasOne(d => d.Lead).WithMany(p => p.CrmTagRels).HasConstraintName("crm_tag_rel_lead_id_fkey");
        });
        ...
        {
            entity.HasKey(e => new { e.EmpId, e.CategoryId }).HasName("employee_category_rel_pkey");

            entity.HasOne(d => d.Emp).WithMany(p => p.EmployeeCategoryRels).HasConstraintName("employee_category_rel_emp_id_fkey");
        });
        ...
        modelBuilder.Entity<FleetServiceTypeFleetVehicleLogContractRel>(entity =>
        {
            entity.HasKey(e => new { e.FleetVehicleLogContractId, e.FleetServiceTypeId }).HasName("fleet_service_type_fleet_vehicle_log_contract_rel_pkey");

            entity.HasOne(d => d.FleetVehicleLogContract).WithMany(p => p.FleetServiceTypeFleetVehicleLogContractRels).HasConstraintName("fleet_service_type_fleet_vehi_fleet_vehicle_log_contract_i_fkey");
        });
        ...
        modelBuilder.Entity<FleetVehicleVehicleTagRel>(entity =>
        {
            entity.HasKey(e => new { e.VehicleTagId, e.TagId }).HasName("fleet_vehicle_vehicle_tag_rel_pkey");

            entity.HasOne(d => d.VehicleTag).WithMany(p => p.FleetVehicleVehicleTagRels).HasConstraintName("fleet_vehicle_vehicle_tag_rel_vehicle_tag_id_fkey");
        });
        ...
        modelBuilder.Entity<HrApplicantHrApplicantCategoryRel>(entity =>
        {
            entity.HasKey(e => new { e.HrApplicantId, e.HrApplicantCategoryId }).HasName("hr_applicant_hr_applicant_category_rel_pkey");

            entity.HasOne(d => d.HrApplicant).WithMany(p => p.HrApplicantHrApplicantCategoryRels).HasConstraintName("hr_applicant_hr_applicant_category_rel_hr_applicant_id_fkey");
        });
        ...
        modelBuilder.Entity<HrJobHrRecruitmentStageRel>(entity =>
        {
            entity.HasKey(e => new { e.HrRecruitmentStageId, e.HrJobId }).HasName("hr_job_hr_recruitment_stage_rel_pkey");

            entity.HasOne(d => d.HrJob).WithMany(p => p.HrJobHrRecruitmentStageRels).HasConstraintName("hr_job_hr_recruitment_stage_rel_hr_job_id_fkey");
        });
        ...
        modelBuilder.Entity<MailActivityRel>(entity =>
        {
            entity.HasKey(e => new { e.ActivityId, e.RecommendedId }).HasName("mail_activity_rel_pkey");
        });
        ...
        modelBuilder.Entity<MailActivityTypeMailTemplateRel>(entity =>
        {
            entity.HasKey(e => new { e.MailActivityTypeId, e.MailTemplateId }).HasName("mail_activity_type_mail_template_rel_pkey");

            entity.HasOne(d => d.MailTemplate).WithMany(p => p.MailActivityTypeMailTemplateRels).HasConstraintName("mail_activity_type_mail_template_rel_mail_template_id_fkey");
        });
        ...
        {
            entity.HasKey(e => new { e.MailFollowersId, e.MailMessageSubtypeId }).HasName("mail_followers_mail_message_subtype_rel_pkey");

            entity.HasOne(d => d.MailFollowers).WithMany(p => p.MailFollowersMailMessageSubtypeRels).HasConstraintName("mail_followers_mail_message_subtype_rel_mail_followers_id_fkey");
        });
        ...
        modelBuilder.Entity<MeetingCategoryRel>(entity =>
        {
            entity.HasKey(e => new { e.EventId, e.TypeId }).HasName("meeting_category_rel_pkey");

            entity.HasOne(d => d.Event).WithMany(p => p.MeetingCategoryRels).HasConstraintName("meeting_category_rel_event_id_fkey");
        });
        ...
        modelBuilder.Entity<MrpWorkcenterMrpWorkcenterTagRel>(entity =>
        {
            entity.HasKey(e => new { e.MrpWorkcenterId, e.MrpWorkcenterTagId }).HasName("mrp_workcenter_mrp_workcenter_tag_rel_pkey");

            entity.HasOne(d => d.MrpWorkcenter).WithMany(p => p.MrpWorkcenterMrpWorkcenterTagRels).HasConstraintName("mrp_workcenter_mrp_workcenter_tag_rel_mrp_workcenter_id_fkey");
        });
        ...
        modelBuilder.Entity<NoteStageRel>(entity =>
        {
            entity.HasKey(e => new { e.NoteId, e.StageId }).HasName("note_stage_rel_pkey");

            entity.HasOne(d => d.Note).WithMany(p => p.NoteStageRels).HasConstraintName("note_stage_rel_note_id_fkey");
        });
        ...
        modelBuilder.Entity<PaymentCountryRel>(entity =>
        {
            entity.HasKey(e => new { e.PaymentId, e.CountryId }).HasName("payment_country_rel_pkey");

            entity.HasOne(d => d.Payment).WithMany(p => p.PaymentCountryRels).HasConstraintName("payment_country_rel_payment_id_fkey");
        });
        ...
        modelBuilder.Entity<PosCategoryPosConfigRel>(entity =>
        {
            entity.HasKey(e => new { e.PosConfigId, e.PosCategoryId }).HasName("pos_category_pos_config_rel_pkey");

            entity.HasOne(d => d.PosConfig).WithMany(p => p.PosCategoryPosConfigRels).HasConstraintName("pos_category_pos_config_rel_pos_config_id_fkey");
        });

        modelBuilder.Entity<PosCategoryResConfigSettingsRel>(entity =>
        {
            entity.HasKey(e => new { e.ResConfigSettingsId, e.PosCategoryId }).HasName("pos_category_res_config_settings_rel_pkey");

            entity.HasOne(d => d.ResConfigSettings).WithMany(p => p.PosCategoryResConfigSettingsRels).HasConstraintName("pos_category_res_config_settings_re_res_config_settings_id_fkey");
        });
        ...
        modelBuilder.Entity<PosConfigPosPaymentMethodRel>(entity =>
        {
            entity.HasKey(e => new { e.PosConfigId, e.PosPaymentMethodId }).HasName("pos_config_pos_payment_method_rel_pkey");

            entity.HasOne(d => d.PosConfig).WithMany(p => p.PosConfigPosPaymentMethodRels).HasConstraintName("pos_config_pos_payment_method_rel_pos_config_id_fkey");
        });
        ...
        modelBuilder.Entity<ProductAttributeProductTemplateRel>(entity =>
        {
            entity.HasKey(e => new { e.ProductAttributeId, e.ProductTemplateId }).HasName("product_attribute_product_template_rel_pkey");

            entity.HasOne(d => d.ProductTemplate).WithMany(p => p.ProductAttributeProductTemplateRels).HasConstraintName("product_attribute_product_template_rel_product_template_id_fkey");
        });
        ...
        modelBuilder.Entity<ProductPublicCategoryProductTemplateRel>(entity =>
        {
            entity.HasKey(e => new { e.ProductPublicCategoryId, e.ProductTemplateId }).HasName("product_public_category_product_template_rel_pkey");

            entity.HasOne(d => d.ProductTemplate).WithMany(p => p.ProductPublicCategoryProductTemplateRels).HasConstraintName("product_public_category_product_templa_product_template_id_fkey");
        });
        ...
        modelBuilder.Entity<ProductTagProductProductRel>(entity =>
        {
            entity.HasKey(e => new { e.ProductProductId, e.ProductTagId }).HasName("product_tag_product_product_rel_pkey");

            entity.HasOne(d => d.ProductProduct).WithMany(p => p.ProductTagProductProductRels).HasConstraintName("product_tag_product_product_rel_product_product_id_fkey");
        });

        modelBuilder.Entity<ProductTagProductTemplateRel>(entity =>
        {
            entity.HasKey(e => new { e.ProductTemplateId, e.ProductTagId }).HasName("product_tag_product_template_rel_pkey");

            entity.HasOne(d => d.ProductTemplate).WithMany(p => p.ProductTagProductTemplateRels).HasConstraintName("product_tag_product_template_rel_product_template_id_fkey");
        });
        ...
        modelBuilder.Entity<ProjectProjectProjectTagsRel>(entity =>
        {
            entity.HasKey(e => new { e.ProjectProjectId, e.ProjectTagsId }).HasName("project_project_project_tags_rel_pkey");

            entity.HasOne(d => d.ProjectProject).WithMany(p => p.ProjectProjectProjectTagsRels).HasConstraintName("project_project_project_tags_rel_project_project_id_fkey");
        });
        ...
        modelBuilder.Entity<ProjectTagsProjectTaskRel>(entity =>
        {
            entity.HasKey(e => new { e.ProjectTaskId, e.ProjectTagsId }).HasName("project_tags_project_task_rel_pkey");

            entity.HasOne(d => d.ProjectTask).WithMany(p => p.ProjectTagsProjectTaskRels).HasConstraintName("project_tags_project_task_rel_project_task_id_fkey");
        });
        ...
        modelBuilder.Entity<ProjectTaskTypeProjectTaskTypeDeleteWizardRel>(entity =>
        {
            entity.HasKey(e => new { e.ProjectTaskTypeDeleteWizardId, e.ProjectTaskTypeId }).HasName("project_task_type_project_task_type_delete_wizard_rel_pkey");

            entity.HasOne(d => d.ProjectTaskTypeDeleteWizard).WithMany(p => p.ProjectTaskTypeProjectTaskTypeDeleteWizardRels).HasConstraintName("project_task_type_project_tas_project_task_type_delete_wiz_fkey");
        });

        modelBuilder.Entity<ProjectTaskTypeRel>(entity =>
        {
            entity.HasKey(e => new { e.TypeId, e.ProjectId }).HasName("project_task_type_rel_pkey");

            entity.HasOne(d => d.Project).WithMany(p => p.ProjectTaskTypeRels).HasConstraintName("project_task_type_rel_project_id_fkey");
        });
        ...
        modelBuilder.Entity<RepairOrderRepairTagsRel>(entity =>
        {
            entity.HasKey(e => new { e.RepairOrderId, e.RepairTagsId }).HasName("repair_order_repair_tags_rel_pkey");

            entity.HasOne(d => d.RepairOrder).WithMany(p => p.RepairOrderRepairTagsRels).HasConstraintName("repair_order_repair_tags_rel_repair_order_id_fkey");
        });
        ...
        modelBuilder.Entity<ResCountryGroupPricelistRel>(entity =>
        {
            entity.HasKey(e => new { e.PricelistId, e.ResCountryGroupId }).HasName("res_country_group_pricelist_rel_pkey");

            entity.HasOne(d => d.Pricelist).WithMany(p => p.ResCountryGroupPricelistRels).HasConstraintName("res_country_group_pricelist_rel_pricelist_id_fkey");
        });

        modelBuilder.Entity<ResCountryResCountryGroupRel>(entity =>
        {
            entity.HasKey(e => new { e.ResCountryId, e.ResCountryGroupId }).HasName("res_country_res_country_group_rel_pkey");
        });
        ...
        modelBuilder.Entity<ResLangInstallRel>(entity =>
        {
            entity.HasKey(e => new { e.LanguageWizardId, e.LangId }).HasName("res_lang_install_rel_pkey");

            entity.HasOne(d => d.LanguageWizard).WithMany(p => p.ResLangInstallRels).HasConstraintName("res_lang_install_rel_language_wizard_id_fkey");
        });
        ...
        {
            entity.HasKey(e => new { e.CategoryId, e.PartnerId }).HasName("res_partner_res_partner_category_rel_pkey");

            entity.HasOne(d => d.Partner).WithMany(p => p.ResPartnerResPartnerCategoryRels).HasConstraintName("res_partner_res_partner_category_rel_partner_id_fkey");
        });
        ...
        modelBuilder.Entity<SaleOrderTagRel>(entity =>
        {
            entity.HasKey(e => new { e.OrderId, e.TagId }).HasName("sale_order_tag_rel_pkey");

            entity.HasOne(d => d.Order).WithMany(p => p.SaleOrderTagRels).HasConstraintName("sale_order_tag_rel_order_id_fkey");
        });
        ...
        modelBuilder.Entity<StockPackageTypeStockPutawayRuleRel>(entity =>
        {
            entity.HasKey(e => new { e.StockPutawayRuleId, e.StockPackageTypeId }).HasName("stock_package_type_stock_putaway_rule_rel_pkey");

            entity.HasOne(d => d.StockPutawayRule).WithMany(p => p.StockPackageTypeStockPutawayRuleRels).HasConstraintName("stock_package_type_stock_putaway_rul_stock_putaway_rule_id_fkey");
        });
        ...
        modelBuilder.Entity<StockRouteCateg>(entity =>
        {
            entity.HasKey(e => new { e.RouteId, e.CategId }).HasName("stock_route_categ_pkey");

            entity.HasOne(d => d.Route).WithMany(p => p.StockRouteCategs).HasConstraintName("stock_route_categ_route_id_fkey");
        });
        ...
        modelBuilder.Entity<UtmTagRel>(entity =>
        {
            entity.HasKey(e => new { e.TagId, e.CampaignId }).HasName("utm_tag_rel_pkey");

            entity.HasOne(d => d.Tag).WithMany(p => p.UtmTagRels).HasConstraintName("utm_tag_rel_tag_id_fkey");
        });
        ...
        modelBuilder.Entity<WebsiteLangRel>(entity =>
        {
            entity.HasKey(e => new { e.WebsiteId, e.LangId }).HasName("website_lang_rel_pkey");

            entity.HasOne(d => d.Website).WithMany(p => p.WebsiteLangRels).HasConstraintName("website_lang_rel_website_id_fkey");
        });

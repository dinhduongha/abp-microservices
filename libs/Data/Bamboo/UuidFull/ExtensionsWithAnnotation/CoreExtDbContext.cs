...
public partial class CoreDbContext
{
    ...
    public virtual DbSet<AccountAccountAccountTag> AccountAccountAccountTags { get; set; }

    public virtual DbSet<AccountAccountFinancialReportType> AccountAccountFinancialReportTypes { get; set; }

    public virtual DbSet<AccountAccountTag> AccountAccountTags { get; set; }

    public virtual DbSet<AccountAccountTagAccountMoveLineRel> AccountAccountTagAccountMoveLineRels { get; set; }

    public virtual DbSet<AccountAccountTagAccountTaxRepartitionLineRel> AccountAccountTagAccountTaxRepartitionLineRels { get; set; }

    public virtual DbSet<AccountAccountTagProductTemplateRel> AccountAccountTagProductTemplateRels { get; set; }

    public virtual DbSet<AccountAccountTemplate> AccountAccountTemplates { get; set; }

    public virtual DbSet<AccountAccountTemplateAccountTag> AccountAccountTemplateAccountTags { get; set; }
    ...
    public virtual DbSet<AccountEdiFormatAccountJournalRel> AccountEdiFormatAccountJournalRels { get; set; }
    ...
    public virtual DbSet<AccountFiscalPositionResCountryStateRel> AccountFiscalPositionResCountryStateRels { get; set; }
    ...
    public virtual DbSet<AccountFiscalPositionTemplateResCountryStateRel> AccountFiscalPositionTemplateResCountryStateRels { get; set; }
    ...
    public virtual DbSet<AccountReconcileModelResPartnerCategoryRel> AccountReconcileModelResPartnerCategoryRels { get; set; }

    public virtual DbSet<AccountReconcileModelTemplate> AccountReconcileModelTemplates { get; set; }

    public virtual DbSet<AccountReconcileModelTemplateResPartnerCategoryRel> AccountReconcileModelTemplateResPartnerCategoryRels { get; set; }
    ...
    public virtual DbSet<AccountTaxRepartitionFinancialTag> AccountTaxRepartitionFinancialTags { get; set; }
    ...
    public virtual DbSet<CrmIapLeadIndustryCrmIapLeadMiningRequestRel> CrmIapLeadIndustryCrmIapLeadMiningRequestRels { get; set; }

    public virtual DbSet<CrmIapLeadMiningRequest> CrmIapLeadMiningRequests { get; set; }

    public virtual DbSet<CrmIapLeadMiningRequestCrmIapLeadRoleRel> CrmIapLeadMiningRequestCrmIapLeadRoleRels { get; set; }

    public virtual DbSet<CrmIapLeadMiningRequestCrmTagRel> CrmIapLeadMiningRequestCrmTagRels { get; set; }

    public virtual DbSet<CrmIapLeadMiningRequestResCountryRel> CrmIapLeadMiningRequestResCountryRels { get; set; }

    public virtual DbSet<CrmIapLeadMiningRequestResCountryStateRel> CrmIapLeadMiningRequestResCountryStateRels { get; set; }
    ...
    public virtual DbSet<CrmTagRel> CrmTagRels { get; set; }
    ...
    public virtual DbSet<FleetServiceTypeFleetVehicleLogContractRel> FleetServiceTypeFleetVehicleLogContractRels { get; set; }
    ...
    public virtual DbSet<FleetVehicleVehicleTagRel> FleetVehicleVehicleTagRels { get; set; }
    ...
    public virtual DbSet<HrApplicantHrApplicantCategoryRel> HrApplicantHrApplicantCategoryRels { get; set; }
    ...
    public virtual DbSet<HrJobHrRecruitmentStageRel> HrJobHrRecruitmentStageRels { get; set; }
    ...
    public virtual DbSet<MailActivityRel> MailActivityRels { get; set; }

    public virtual DbSet<MailActivityType> MailActivityTypes { get; set; }

    public virtual DbSet<MailActivityTypeMailTemplateRel> MailActivityTypeMailTemplateRels { get; set; }
    ...
    public virtual DbSet<MeetingCategoryRel> MeetingCategoryRels { get; set; }
    ...
    public virtual DbSet<MrpWorkcenterMrpWorkcenterTagRel> MrpWorkcenterMrpWorkcenterTagRels { get; set; }
    ...
    public virtual DbSet<NoteStageRel> NoteStageRels { get; set; }

    public virtual DbSet<NoteTag> NoteTags { get; set; }

    public virtual DbSet<PartnerStatRel> PartnerStatRels { get; set; }

    public virtual DbSet<PaymentCountryRel> PaymentCountryRels { get; set; }
    ...
    public virtual DbSet<PosCategoryPosConfigRel> PosCategoryPosConfigRels { get; set; }

    public virtual DbSet<PosCategoryResConfigSettingsRel> PosCategoryResConfigSettingsRels { get; set; }
    ...
    public virtual DbSet<PosConfigPosPaymentMethodRel> PosConfigPosPaymentMethodRels { get; set; }
    ...
    public virtual DbSet<ProductAttributeProductTemplateRel> ProductAttributeProductTemplateRels { get; set; }
    ...
    public virtual DbSet<ProductPublicCategoryProductTemplateRel> ProductPublicCategoryProductTemplateRels { get; set; }
    ...
    public virtual DbSet<ProductTagProductProductRel> ProductTagProductProductRels { get; set; }

    public virtual DbSet<ProductTagProductTemplateRel> ProductTagProductTemplateRels { get; set; }
    ...
    public virtual DbSet<ProjectProjectProjectTagsRel> ProjectProjectProjectTagsRels { get; set; }
    ...
    public virtual DbSet<ProjectTagsProjectTaskRel> ProjectTagsProjectTaskRels { get; set; }
    ...
    public virtual DbSet<ProjectTaskTypeProjectTaskTypeDeleteWizardRel> ProjectTaskTypeProjectTaskTypeDeleteWizardRels { get; set; }

    public virtual DbSet<ProjectTaskTypeRel> ProjectTaskTypeRels { get; set; }
    ...
    public virtual DbSet<RepairOrderRepairTagsRel> RepairOrderRepairTagsRels { get; set; }
    ...
    public virtual DbSet<ResCountryGroupPricelistRel> ResCountryGroupPricelistRels { get; set; }
    ...
    public virtual DbSet<ResLangInstallRel> ResLangInstallRels { get; set; }
    ...
    public virtual DbSet<SaleOrderTagRel> SaleOrderTagRels { get; set; }
    ...
    public virtual DbSet<StockPackageTypeStockPutawayRuleRel> StockPackageTypeStockPutawayRuleRels { get; set; }
    ...
    public virtual DbSet<StockRouteCateg> StockRouteCategs { get; set; }
    ...
    public virtual DbSet<UtmTagRel> UtmTagRels { get; set; }
    ...
    public virtual DbSet<WebsiteLangRel> WebsiteLangRels { get; set; }
